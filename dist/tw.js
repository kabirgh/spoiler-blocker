...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mainLogic = __webpack_require__(/*! ./common/mainLogic */ 2);

	var _mainLogic2 = _interopRequireDefault(_mainLogic);

	var _twConfig = __webpack_require__(/*! ./common/site_config/twConfig */ 285);
	...
	(0, _jquery2.default)(document).ready(function () {
		(0, _mainLogic2.default)(globalSpoilersArr, _twConfig.twConfig);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = hideContent;

	var _jquery = __webpack_require__(/*! jquery */ 1);

	var _jquery2 = _interopRequireDefault(_jquery);

	var _JqueryUtils = __webpack_require__(/*! ./util/JqueryUtils */ 3);

	var _JqueryUtils2 = _interopRequireDefault(_JqueryUtils);

	var _CommonUtils = __webpack_require__(/*! ./util/CommonUtils */ 4);

	var _CommonUtils2 = _interopRequireDefault(_CommonUtils);

	var _DOMObserver = __webpack_require__(/*! ./DOMObserver */ 5);
	...
	function observeBodyClass() {
		var bodyNode = (0, _jquery2.default)("body")[0];
		var bodyObserver = new _DOMObserver2.default(bodyNode);
	...
	function pollFeed() {
		var feedSelector = _siteConfig["feedSelector"];
		_JqueryUtils2.default.pollForElem(feedSelector, 100, 5000, observeFeed);
	}
	...
	function observeFeed($feed) {
		...
		var feedObserver = new _DOMObserver2.default($feed[0]);
		var queries = [{ element: _siteConfig["elementQuery"] }];
		feedObserver.observeAddedNodes(queries, optionallyHideContent);
	}

	function hideInitialContent() {
		// Hide posts on initial load
		var $initialContent = getInitialContent();
	...
	function getInitialContent() {
		var jqueryArr = [],
		    arr = [];
		_siteConfig["initialContentSelectors"].map(function (selector) {
			return jqueryArr.push((0, _jquery2.default)(selector));
		});
		...
		for (var i = 0; i < jqueryArr.length; i++) {
			...
			jqueryArr[i].each(function () {
				arr.push((0, _jquery2.default)(this));
			});
		}
		return arr;
	}
	...
	function optionallyHideContent(list) {
		var $contentArr = optionallyFilterContent(list);
		var $contentContainerArr = optionallyGetContentContainers($contentArr);

		var contentText = void 0;

		for (var i = 0; i < $contentContainerArr.length; i++) {
	...
	function optionallyFilterContent(list) {
		...
		var contentSelector = _siteConfig["newContentSelector"];

		var $contentArr = [];
		if (contentSelector !== null) {
			$contentArr = _JqueryUtils2.default.filterElems(list, contentSelector);
		} else {
			// Method suitable for iterating over arrays or NodeLists
			for (var i = 0; i < list.length; i++) {
				$contentArr.push((0, _jquery2.default)(list[i]));
			}
		}
	...
	function optionallyGetContentContainers($contentArr) {
		...
		var containerSelector = _siteConfig["containerSelector"];

		var $contentContainerArr = [];
		if (containerSelector !== null) {
			$contentContainerArr = _JqueryUtils2.default.getClosestAncestors($contentArr, containerSelector);
		} else {
	...
	function getText($elem) {
		var text = void 0;
		var textSelector = _siteConfig["textSelector"];
...
/***/ 3:
/*!**********************************************!*\
  !*** ./src/logic/common/util/JqueryUtils.js ***!
  \**********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	function pollForElem(jquerySelector, interval, timeout, callback) {
		var callbackArgs = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : [];
	...
	function pollForElemHelper(jquerySelector, callback, callbackArgs) {
		var $elem = (0, _jquery2.default)(jquerySelector);

		if ($elem.length !== 0) {
			callback.apply(undefined, [$elem].concat(_toConsumableArray(callbackArgs)));
			return true;
		} else {
			return false;
		}
	...
	function filterElems(elemList, jquerySelector) {
		...
		for (var i = 0; i < elemList.length; i++) {
			var $filteredList = (0, _jquery2.default)(elemList[i]).find(jquerySelector);

			$filteredList.each(function (index, domNode) {
				var $jqueryNode = (0, _jquery2.default)(domNode);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function hideContent($content, contentText, spoilersArr, siteConfig) {
		...
		for (var i = 0; i < activeSpoilers.length; i++) {
			...
			if (!spoilerObj["isCaseSensitive"]) {
				...
				tagArr = tagArr.map(function (tag) {
	...
	function overlay($elem, listTitle, overlayHeight) {
		...
		var $newDiv = (0, _jquery2.default)(document.createElement("div")).css({
			"position": "absolute",
			"top": 0,
			"left": 0,
...
/***/ 5:
/*!*****************************************!*\
  !*** ./src/logic/common/DOMObserver.js ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _mutationSummary = __webpack_require__(/*! mutation-summary */ 6);
	...
	var DOMObserver = function () {
		...
		_createClass(DOMObserver, [{
			key: "notifyAttributeChange",
			value: function notifyAttributeChange(attributes, callback) {
			...
			key: "observeAddedNodes",
			value: function observeAddedNodes(queries, callback) {
				function internalAddedNodesCallback(summaries) {
					callback(summaries[0].added);
				}

				var observer = new _mutationSummary2.default({
			...
			value: function disconnectAttributesObserver() {
			...
			key: "disconnectAddedNodesObserver",
			value: function disconnectAddedNodesObserver() {
...
/***/ 285:
/*!**************************************************!*\
  !*** ./src/logic/common/site_config/twConfig.js ***!
  \**************************************************/
/***/ function(module, exports) {
